...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./var/www/html/livestore/public/storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/html/livestore/public/storage','fortify.guard',
...
'concurrency.default','view.paths','view.compiled','livewire.class_namespace','livewire.view_path',
...
'livewire.update','livewire.upload-file','livewire.preview-file','home','categories','new-arrival',
'about-us','cart','profile','wishlist',
...
'components.input','components.input-error','components.label','components.layouts.app','components.modal',
...
'layouts.app','layouts.guest','livewire.footer','livewire.home','livewire.product-card',
'navigation-menu','policy','profile.delete-user-form','profile.logout-other-browser-sessions-form','profile.show',
'profile.two-factor-authentication-form','profile.update-password-form','profile.update-profile-information-form','terms','welcome',
